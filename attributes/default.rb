...
override['logstash']['instance']['server']['config_templates_cookbook'] = 'logger-cookbook'
override['logstash']['instance']['server']['config_templates']          = {
  'syslog' => 'config/syslog_config.conf.erb',
  'rails' => 'config/rails_config.conf.erb',
}

override['logstash']['instance']['default']['config_templates_cookbook'] = 'logger-cookbook'
